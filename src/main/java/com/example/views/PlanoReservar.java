...
public class PlanoReservar extends JPanel implements ActionListener {
	...
	public PlanoReservar(GestionRestaurante gestionRestaurante) {
		...
		btnMesa6.setBounds(430, 486, 52, 23);
		...
		btnMesa7.setBounds(570, 486, 52, 23);
		...
		btnMesa8.setBounds(711, 486, 52, 23);
		...
		btnMesa9.setBounds(852, 486, 52, 23);
		...
		btnMesa10.setBounds(444, 624, 52, 23);
		...
		btnMesa11.setBounds(584, 624, 52, 23);
		...
		btnMesa12.setBounds(724, 624, 52, 23);
		...
		btnMesa13.setBounds(865, 624, 52, 23);
